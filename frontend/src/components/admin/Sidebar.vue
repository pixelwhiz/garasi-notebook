...
<template>
  <div class="bg-primary fixed z-[1] h-full" style="background: linear-gradient(to bottom, #5a89d5, #5b89d4);">
    ...
    <div class="grid subtitle gap-0">
      ...
      <a href="/admin/settings" class="py-2 text-base-content hover:bg-base-100/80" :class="{ 'bg-base-100/40': this.$route.path === '/admin/settings' }">
        <label href="" class="btn">
        <span class="me-2 ms-1">
          ...
          <span class="text-gray-300 font-medium subtitle">Settings</span>
        </label>
      </a>
      <a href="/admin/logout" class="py-2 text-base-content hover:bg-base-100/80" :class="{ 'bg-base-100/40': this.$route.path === '/admin/logout' }">
        <label href="" class="btn">
        <span class="me-2 ms-1">
